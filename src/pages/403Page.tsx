        ...
        <section className="bg-white ">
            <div className="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
                <div className="wf-ull lg:w-1/2">
                    <p className="text-sm font-medium text-red-500">403 error</p>
                    <h1 className="mt-3 text-2xl font-semibold text-gray-800 md:text-3xl">Access Forbidden</h1>
                    <p className="mt-4 text-gray-500">Sorry, you don't have permission to access this page. Here are some helpful links:</p>
