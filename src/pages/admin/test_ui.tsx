            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  >
                    <div className="flex items-center gap-1">
                      Tuyến đường <SortIcon field="routeName" />
                    </div>
                  </th>
                  ...
                  >
                    <div className="flex items-center gap-1">
                      Ca / Thời gian <SortIcon field="type" />
                    </div>
                  </th>
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                    Ngày hoạt động
                ...
                {paginatedSchedules.map((schedule) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      ...
                      <div className="text-xs text-gray-500">ID: {schedule.routeId}</div>
                    </td>
                    <td className="px-4 py-3">
                      <div className="text-sm text-gray-900">{schedule.busNumber}</div>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                          ...
                          {schedule.type === 'MORNING' ? 'Sáng' : 'Chiều'}
                        </span>
                      </div>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex flex-col gap-1">
                        ...
                        {schedule.meta?.priority && (
                          <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                            schedule.meta.priority === 'HIGH' 
                              ? 'bg-red-100 text-red-700' 
                              : schedule.meta.priority === 'MEDIUM'
                              ? 'bg-yellow-100 text-yellow-700'
                              : 'bg-gray-100 text-gray-700'
                          }`}>
                            {schedule.meta.priority === 'HIGH' ? 'Cao' : 
                             schedule.meta.priority === 'MEDIUM' ? 'TB' : 'Thấp'}
                          </span>
                        )}
                      </div>
                    </td>
