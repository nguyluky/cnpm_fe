      ...
      <div className="malign-items-center text-center x-10 flex justify-center items-center">
        <div className="rounded-xl bg-white max-w-120 p-5 shadow-2xl text-center">
          ...
          <div className="flex items-center mb-4">
            ...
            <input type="text" id="username" name="username" className="flex-1 border border-gray-300 p-2 rounded-md" placeholder="parent/driver/admin" />
          </div>
          <div className="flex items-center mb-4">
            <label htmlFor="password" className="w-32 text-left mb-2 font-semibold">Password</label>
            <input type="password" id="password" name="password" className="flex-1 border border-gray-300 p-2 rounded-md" placeholder="123" />
          </div>
